...
## Παραδοτέο Β
 ...
 Η δημιουργία του εκτελέσιμου μέσω του Github pages, επετεύχθει αλλάζοντας το tag "include_relative" στα αρχεία που το περιείχαν,  με το tag "include". Εν συνεχεία μετέφερα τα αρχεία .md που περιείχαν αυτό το tag  στο directory _includes.
